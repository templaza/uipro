<?php
/**
 * UIPro Elementor Card Grid widget
 *
 * @version     1.0.0
 * @author      TemPlaza.com
...
if ( ! class_exists( 'UIPro_El_UICardGrid' ) ) {
	/**
	 * Class UIPro_El_UICardGrid
	 */
	class UIPro_El_UICardGrid extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UICardGrid';
