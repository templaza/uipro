...
if ( ! class_exists( 'UIPro_El_Woo_Grid' ) ) {
	/**
	 * Class Templaza_Elements_El_Woo_Grid
	 */
	class UIPro_El_Woo_Grid extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_Woo_Grid';
