<?php
/**
 * UIPro Elementor Countdown widget
 *
 * @version     1.0.0
 * @author      TemPlaza
...
if ( ! class_exists( 'UIPro_El_UiCountDown' ) ) {
	/**
	 * Class UIPro_El_CountDown
	 */
	class UIPro_El_UiCountDown extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UiCountDown';
