<?php
/**
 * UIPro Elementor Image Parallax widget
 *
 * @version     1.0.0
 * @author      ThimPress
...
if ( ! class_exists( 'UIPro_El_UIImageParallax' ) ) {
	/**
	 * Class UIPro_El_UIImageParallax
	 */
	class UIPro_El_UIImageParallax extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UIImageParallax';
