...
if ( ! class_exists( 'UIPro_El_UIImageTransition' ) ) {
	/**
	 * Class UIPro_El_Heading
	 */
	class UIPro_El_UIImageTransition extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UIImageTransition';
