!function (e, t) {
    ...
    var r =/*#__PURE__*/i(e), o =/*#__PURE__*/n(t);
    return function (e) {
        function t() {
        ...
        var n = e.parent, i = e.displacementImage, a = e.image1, s = e.image2, f = t(e.imagesRatio, 1),
            ...
            p = t(e.speedOut, e.speed, 1.2), g = t(e.hover, !0), h = t(e.easing, "expo.out"), y = t(e.video, !1);
        if (n) if (a && s && i) {
            var F = new r.Scene,
            ...
            if (W.magFilter = W.minFilter = r.LinearFilter, y) {
                ...
                var P = new r.VideoTexture(y), M = new r.VideoTexture(V);
            ...
            var R = new r.ShaderMaterial({
                ...
                transparent: !0,
                opacity: 1
            }), U = new r.PlaneGeometry(n.offsetWidth, n.offsetHeight, 1), _ = new r.Mesh(U, R);
        ...
        function C() {
            o.default.to(R.uniforms.dispFactor, {duration: m, value: 1, ease: h, onUpdate: L, onComplete: L})
        }

        function D() {
            o.default.to(R.uniforms.dispFactor, {duration: p, value: 0, ease: h, onUpdate: L, onComplete: L})
        }
    }
});
