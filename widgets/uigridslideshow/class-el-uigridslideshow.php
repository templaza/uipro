...
if ( ! class_exists( 'UIPro_El_UIGridSlideshow' ) ) {
	/**
	 * Class UIPro_El_UIGridSlideshow
	 */
	class UIPro_El_UIGridSlideshow extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UIGridSlideshow';
