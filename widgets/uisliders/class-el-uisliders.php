<?php
/**
 * UIPro Elementor Sliders widget
 *
 * @version     1.0.0
 * @author      TemPlaza.com
...
if ( ! class_exists( 'UIPro_El_UISliders' ) ) {
	/**
	 * Class UIPro_El_UISliders
	 */
	class UIPro_El_UISliders extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UISliders';
