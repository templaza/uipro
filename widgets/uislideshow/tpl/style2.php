...
$image_position = ( isset( $instance['image_position'] ) && $instance['image_position'] ) ? $instance['image_position'] : '';
...
$image_position = ( isset( $instance['image_position'] ) && $instance['image_position'] ) ? $instance['image_position'] : '';
$left_class = ' uk-flex-first@m uk-flex-last ';
$right_class = ' uk-flex-last@m uk-flex-first ';

if($image_position=='left'){
    $left_class = ' uk-flex-last@m uk-flex-first ';
    $right_class = ' uk-flex-first@m uk-flex-last ';
}
$output      = '';
...
if ( isset( $instance['uislideshow_items'] ) && count( (array) $instance['uislideshow_items'] ) ) {
	foreach ( $instance['uislideshow_items'] as $key => $value ) {
		...
		$output .= '<li class="el-item uk-margin-remove item-' . $key . '">';
        ...
        $output .= '<div class="ap-slideshow-left uk-width-1-2@m uk-position-relative '.$left_class.'">';
        $output .= '<div class="uk-height-1-1 uk-flex' . $overlay_positions . $overlay_container_cls . '">';

        $output .= '<div class="overlay_custom ' . $overlay_styles_int . $overlay_pos_int .$overlay_container_padding. $overlay_width . $overlay_transition . $text_item_color_cls . $overlay_styles . $overlay_padding . ( ! empty( $overlay_transition ) ? $overlay_transition : '' ) . ' uk-margin-remove-first-child"' . ( empty( $overlay_transition ) ? $overlay_parallax_cls : '' ) . '>';
        ...
        $output .= '</div>';
        $output .= '</div>';
        $output .= '<div class="ap-slideshow-right uk-width-1-2@m '.$right_class.'" >';
        $output .= '<div class="ui-image-style2 uk-width-1-1 uk-height-1-1 uk-flex">
                    <img src="'.$image_src.'"/>
                    </div>';
        $output .= '</div>';
        $output .= '</div>';
