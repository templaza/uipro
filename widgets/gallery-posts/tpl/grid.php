...
//	wp_enqueue_script('isotope');
	...
	while ( $posts_display->have_posts() ) : $posts_display->the_post();
		...
		$html .= apply_filters( 'templaza_before_gallery_popup', '', get_the_ID() );
		$html .= '<a class="templaza-gallery-popup" href="#" data-id="' . get_the_ID() . '">' . $img . '</a>';
		$html .= apply_filters( 'templaza_after_gallery_popup', '', get_the_ID() );
		$html .= '</div>';
...
<?php endif; ?>
    ...
    <?php while ( $posts_display->have_posts() ){ $posts_display->the_post(); ?>
