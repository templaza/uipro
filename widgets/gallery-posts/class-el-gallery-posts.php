...
if ( ! class_exists( 'UIPro_El_Gallery_Posts' ) ) {
	/**
	 * Class UIPro_El_Gallery_Posts
	 */
	class UIPro_El_Gallery_Posts extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_Gallery_Posts';
