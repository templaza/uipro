<?php
/**
 * UIPro Elementor Run Text widget
 *
 * @version     1.0.0
 * @author      TemPlaza.com
...
if ( ! class_exists( 'UIPro_El_UIRunText' ) ) {
	/**
	 * Class UIPro_El_UIRunText
	 */
	class UIPro_El_UIRunText extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UIRunText';
