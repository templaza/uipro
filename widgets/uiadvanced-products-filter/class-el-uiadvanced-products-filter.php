...
if ( ! class_exists( 'UIPro_El_UIAdvanced_Products_Filter' ) ) {
	/**
	 * Class UIPro_El_UIAdvanced_Products_Filter
	 */
	class UIPro_El_UIAdvanced_Products_Filter extends UIPro_El_Widget {

		/**
		 * @var string
		 */
		protected $config_class = 'UIPro_Config_UIAdvanced_Products_Filter';
